...
type ForwardMaterialCache cache.T[*material.Def, []Material]

func NewForwardMaterialCache(app vulkan.App, pass renderpass.T, frames int, lookup ShadowmapLookupFn) ForwardMaterialCache {
